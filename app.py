...
class File:
    def __init__(self,root):
        self.root=root
        self.root.title("Data File Extention")
        self.root.geometry("500x400")
        self.root.iconbitmap("logo789.ico")
...
#======================================================================================#
        ...
        def clear():
            ...
            filextention.set("Select Data File Extention")
                ...
                if path.get()!="":
                    ...
                    if filextention.get()!="Select Data File Extention":
                        if filename.get()!="":
                            ...
                            if filextention.get()=="Comma separated value file" and filename.get()!="":
                                touch.touch(a+"/{}.csv".format(filename.get()))
                            
                            if filextention.get()=="Data file" and filename.get()!="":
                                touch.touch(a+"/{}.dat".format(filename.get()))
                        

                            if filextention.get()=="Database file" and filename.get()!="":
                                touch.touch(a+"/{}.db".format(filename.get()))
                            

                            if filextention.get()=="Microsoft Access database file" and filename.get()!="":
                                touch.touch(a+"/{}.mdb".format(filename.get()))

                            if filextention.get()=="Save file (e.g., game save file)" and filename.get()!="":
                                touch.touch(a+"/{}.sav".format(filename.get()))

                            if filextention.get()=="SQL database file" and filename.get()!="":
                                touch.touch(a+"/{}.sql".format(filename.get()))
                            
                            if filextention.get()=="Linux / Unix tarball file archive" and filename.get()!="":
                                touch.touch(a+"/{}.tar".format(filename.get()))

                            if filextention.get()=="XML file" and filename.get()!="":
...
#======================================================================================#
        ...
        fileselect=["Comma separated value file","Data file","Database file",\
                    "Microsoft Access database file","Save file (e.g., game save file)",\
                    "SQL database file","Linux / Unix tarball file archive","XML file"]
        fileselect_combo=Combobox(firstframe,values=fileselect,font=('arial',12),width=25,state="readonly",textvariable=filextention)
        fileselect_combo.set("Select Data File Extention")
